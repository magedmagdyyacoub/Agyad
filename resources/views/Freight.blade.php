...
<body>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="{{ route('AboutUs') }}">AboutUs</a></li>
            </ul>
          </li>
        </ul>
      </div>
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col">
      <img src="{{ asset('image/C7.jpg')}}" alt="aa" width="100%" height="500px">
    </div>
    <div class="col">
      <h2>Freight refers to the transportation of goods, typically by truck, train, ship, or airplane. This can include raw materials, finished products, and other items that need to be moved from one location to another. Freight companies are responsible for arranging the transportation of these goods, including loading, unloading, and delivery. They may also handle logistics, such as tracking the shipment and coordinating with other companies or agencies to ensure smooth delivery. Freight is a vital part of the global economy, as it allows businesses to move products and materials to where they are needed.</h2></h2>
    </div>
    </div>
  </div>
  <!-- End Content -->
