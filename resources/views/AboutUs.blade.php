...
<body>
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col">
      <img src="{{ asset('image/C6.jpg')}}" alt="aa" width="100%" height="500px">
    </div>
    <div class="col">
      <h2>Ajyad carry out all Export and Import customs clearance services, We take pride in being regarded as one of
        the most reliable and affordable logistic and warehousing service providers in the country. We excel at a range
        of logistic services, which includes trucking services, warehousing services and renting containers.</h2>
    </div>
    </div>
  </div>
  <!-- End Content -->
